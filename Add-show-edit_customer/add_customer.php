...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($errorMessage === "") {
        ...
        if ($mysqli->query($sqladd)) {
            header("Location: show_customer.php"); // เปลี่ยนหน้าเมื่อบันทึกสำเร็จ
            exit;
        } else {
...
<h2 style="color:#831b1b;text-decoration: underline;">เพิ่มข้อมูลลูกค้า</h2>
    <fieldset>
        ...
        <form name="FormAdd" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
            <label>ชื่อ :</label> <input type="text" name="Name"><br><br>
...
<br>
    ...
    <input class="button" type="button" value="ยกเลิก" onclick="window.location.href='show_customer.php';">
    </span>
    </form>
